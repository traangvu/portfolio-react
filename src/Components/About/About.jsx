    ...
    <div id="about" className="about">
      ...
      <div className="about-sections">
        <div className="about-left">
          <img className="about_img" src={graduate_img} alt="graduate" />
          <img className="about_img" src={exchange_img} alt="exchange" />
          <img className="about_img" src={profile_img} alt="profile" />
        </div>
